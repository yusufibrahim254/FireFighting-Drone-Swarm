 ...
 */
public class FireIncident1 implements Runnable {
     ...
     */
    public FireIncident1(String schedulerHost, int schedulerPort) throws SocketException, UnknownHostException {
...
//            FireIncident fireIncident = new FireIncident("192.168.1.2", 5000); // Replace with the IP address of the Scheduler machine
            ...
            FireIncident1 fireIncident = new FireIncident1("localhost", 5000); // Scheduler is on localhost, port 5000
            fireIncident.run();
